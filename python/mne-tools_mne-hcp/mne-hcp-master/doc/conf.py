...
project = u'MNE-HCP'
copyright = u'2016, Denis A. Engemann'
author = u'Denis A. Engemann'
...
latex_documents = [
    (master_doc, 'mne-hcp.tex', u'mne-hcp Documentation',
     u'Denis A. Engemann', 'manual'),
]
...
texinfo_documents = [
    (master_doc, 'mne-hcp', u'MNE-HCP Documentation',
     author, 'mne-hcp', 'Reprocessing the Human Connectome Project MEG data.',
     'Miscellaneous'),
]
