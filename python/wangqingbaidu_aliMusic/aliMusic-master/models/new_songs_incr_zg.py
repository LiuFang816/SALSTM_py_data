...
train_ds = ['20150630', '20150615', '20150601', '20150515', '20150501']
...
#           When max plays is low, the album plays jitters. 
...
#                                        me_column = 'b_%d' %self.me_day_use))
        ...
        SELECT b.artist_id, b.ds,  if ((b.plays + d.plays) is NULL, b.plays,  (b.plays + d.plays))as plays FROM(
            SELECT a.artist_id, a.ds, b.plays FROM 
            artist_play a 
            JOIN 
            {baseline} b 
        ...
        on (b.artist_id = d.artist_id and b.ds = d.ds);
        '''
        cur.execute(genTest.format(baseline = 'baseline%s'%self.toDate,
